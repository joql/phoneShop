        ...
        <form id="filterForm" name="form1" method="get" action="filter.php">
          ...
          <div>
            <ul >
              ...
              <li><a tel="3" href="javascript:Filter('tel','3');">中国电信</a></li>
                 <li ><a tel="4" href="javascript:Filter('tel','4');">虚拟运营商</a></li>
          ...
          <div  style="height:50px;" >
            <ul >
              ...
              <li ><a theme='185' href="javascript:Filter('theme','185');">185</a></li>
              ...
              <li ><a theme='177' href="javascript:Filter('theme','177');">177</a></li>
               ...
               <li ><a theme='173' href="javascript:Filter('theme','173');">173</a></li>
                <li ><a theme='180' href="javascript:Filter('theme','180');">180</a></li>
                 <li ><a theme='181' href="javascript:Filter('theme','181');">181</a></li>
                  <li ><a theme='189' href="javascript:Filter('theme','189');">189</a></li>
          ...
          <div  style="height:110px;" >
            <ul >
              ...
              <li ><a day="36" href="javascript:Filter('day','36');">风水号</a></li>
               <li ><a day="36" href="javascript:Filter('day','37');">尾数ABAB</a></li>
            </ul>
