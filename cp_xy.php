...
<div class="main">
<div class="onepage_bt">当前位置：<a href="/">首页</a>&nbsp;&gt;&nbsp;<a href="cpai.php">车牌选号</a>&nbsp;&gt;&nbsp;黑龙江&nbsp;&gt;&nbsp;<a href="javascript:void(0);" target="_blank"><?php echo $row_Recordset1['smalltype']; ?>车牌号码</a>&nbsp;&gt;<?php echo $row_Recordset1['cp_hao']; ?>车牌详情</div>
<!--固定电话详情-->
	<div class="hmxq fl">
  ...
  <tbody><tr>
    <td colspan="4">
		<h1>
		<span><?php echo $row_Recordset1['cp_hao']; ?></span>
						    </h1>
  ...
  <tr>
    ...
    <td colspan="3" class="hmxq_nr"><?php echo $row_Recordset1['tszf']; ?>
      <!--所属分类-->
      ：</td>
   </tr>
    <tr>
...
<div class="number_01 "><span><a href="cpai.php">更多</a></span>为您推荐其它的车牌靓号</div>
        	<ul>
									<?php do { ?>
								    <li><a href="cp_xy.php?id=<?php echo $row_Recordset2['id']; ?>" target="_blank"><h2><i class="liang"></i><span class="yellow"><?php echo substr($row_Recordset2['cp_hao'],0,5); ?></span><?php echo substr($row_Recordset2['cp_hao'],5,5); ?></h2><p><span class="fl"><?php echo $row_Recordset2['smalltype']; ?></span><span class="fr">￥<span class="red"><?php echo $row_Recordset2['s_price']; ?></span></span></p></a></li>
