...
$order_money = $_GET['price']; //订单金额 元
//$order_money = 0.01; //订单金额 元
//$order_money = $_GET['price']; //订单金额 
//echo "订单支付金额：".$order_money;
//添加订单
//$query = mysql_query("INSERT INTO `order` (`order_no`,`order_money`,`pay_type`,`addtime`,sjh) VALUES ('" . $order_no . "', '" . $order_money . "','zfb_wap', '" . time() . "','".$_GET['sj']."');");
...
$parameter = array(
		...
		"seller_id"  => $alipay_config['partner'],//根据学习视频改成这样，结合alipay.config.php 21行配制端的依据
