              ...
              <tr> 
                <td><strong><font color="#FF0000" size="3">手机号信息管理</font></strong>
                  ...
                  <table width="100%" border="0" cellspacing="1" cellpadding="2">
                    ...
                    <tr bgcolor="#CCCCCC">
                      <td colspan="15" bgcolor="#FFFFFF" ><form name="form1" method="get" action="">
...
<tr>
  ...
  <input type="file" name="inputExcel">
    ...
    <input type="button" value="批量导出数据" onClick="javascript:location.href='./plsc2017/dc/';">
   </td>
</tr>
</table>
</form></td>
...
function chek(){
	...
	return false;
					 ...
					 <form  name="form3"action="del_plsc.php" method="post"><input name="tab" type="hidden" value="sj">
					<?php do { ?>
                    <tr bgcolor="#FFFFFF" style="cursor: hand;" onMouseOver="this.style.backgroundColor='#F0F0F0'" onMouseOut="this.style.backgroundColor=''">
                      ...
                      </tr><?php } while ($row_Recinfo = mysql_fetch_assoc($Recinfo)); ?> 
