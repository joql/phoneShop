...
if ((isset($_GET['id'])) && ($_GET['id'] != "") && (isset($_GET['delsure']))) {
  $deleteSQL = sprintf("DELETE FROM sll WHERE id=%s",
...
echo "<script language='javascript'>alert('删除成功!');location.href='sLL_Admin.php';</script>";
}
...
mysql_select_db($database_connch21, $connch21);
$query_Recinfo = sprintf("SELECT * FROM sll WHERE id = %s", GetSQLValueString($colname_Recinfo, "int"));
    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#EEEEEE">
        <tr valign="top"> 
          ...
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
                <td><font color="#FF0000" size="3"><strong>400号码删除-</strong></font>
                  <?php echo $row_Recinfo['sLL_hao']; ?>
<hr size="1" noshade> 
