...
if ((isset($_GET['xx_id'])) && ($_GET['xx_id'] != "") && (isset($_GET['delsure']))) {
  $deleteSQL = sprintf("DELETE FROM xx_smallclass WHERE xx_id=%s",
                       GetSQLValueString($_GET['xx_id'], "int"));

  mysql_select_db($database_connch21, $connch21);
  $Result1 = mysql_query($deleteSQL, $connch21) or die(mysql_error());

  $deleteGoTo = "smallclassAdmin_xx.php";
...
if (isset($_GET['xx_id'])) {
  $colname_Recordset1 = $_GET['xx_id'];
}
mysql_select_db($database_connch21, $connch21);
$query_Recordset1 = sprintf("SELECT * FROM xx_smallclass WHERE xx_id = %s", GetSQLValueString($colname_Recordset1, "int"));
    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#EEEEEE">
        <tr valign="top"> 
          ...
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
                <td height="62"><font color="#FF0000" size="3"><strong>删除信息小类别-</strong>&nbsp;(C类）</font>
                  <?php echo $row_Recordset1['x_mame']; ?>
                  <hr size="1" noshade> 
                  <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td height="17" valign="top"><font size="2"><strong>所属类别</strong>：<?php echo $row_Recordset1['class_id']; ?>|<?php echo $row_Recordset1['smallclass_id']; ?></font></td>
                    </tr>
                  </table>
                </td>
              </tr>
              <tr> 
                <td><form name="form1" >
                  ...
                  <input name="xx_id" type="hidden" id="smallclass_id" value="<?php echo $row_Recordset1['xx_id']; ?>">
                </form></td>
              </tr>
            </table></td>
