...
if ((isset($_GET['id'])) && ($_GET['id'] != "") && (isset($_GET['delsure']))) {
  $deleteSQL = sprintf("DELETE FROM guanggao WHERE id=%s",
                       GetSQLValueString($_GET['id'], "int"));

  mysql_select_db($database_connch21, $connch21);
  $Result1 = mysql_query($deleteSQL, $connch21) or die(mysql_error());

  $deleteGoTo = "ggao_Admin.php";
...
$colname_Rec_ggao_del = "-1";
if (isset($_GET['id'])) {
  $colname_Rec_ggao_del = $_GET['id'];
}
mysql_select_db($database_connch21, $connch21);
$query_Rec_ggao_del = sprintf("SELECT * FROM guanggao WHERE id = %s", GetSQLValueString($colname_Rec_ggao_del, "int"));
$Rec_ggao_del = mysql_query($query_Rec_ggao_del, $connch21) or die(mysql_error());
$row_Rec_ggao_del = mysql_fetch_assoc($Rec_ggao_del);
$totalRows_Rec_ggao_del = mysql_num_rows($Rec_ggao_del);
?>
<html>
<head>
<title>广告管理</title>
    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#EEEEEE">
        <tr valign="top"> 
          ...
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
                <td><font color="#FF0000" size="3"><strong>删除信息-</strong></font>
<hr size="1" noshade> 
                  <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td valign="top"><font size="2"><strong>日期</strong><?php echo $row_Rec_ggao_del['time']; ?>：<strong> </font></td>
                    </tr>
                  </table>
                </td>
              </tr>
              <tr> 
                <td><form name="form1" method="get" action="">
                  ...
                  <?php echo $row_Rec_ggao_del['title']; ?>
                  <input name="delsure" type="hidden" id="delsure" value="1">
                  <input name="id" type="hidden" id="id" value="<?php echo $row_Rec_ggao_del['id']; ?>">
                </form></td>
              </tr>
            </table></td>
...
<?php
mysql_free_result($Rec_ggao_del);
?>
