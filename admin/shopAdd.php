...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO shop(info_time, classname, smallclassname, xx_smallclass, zx_name, info_title, info_editor, info_photo, info_photo1, info_photo2, info_photo3, info_photo4, info_top, info_flash, info_content, cp_je,px,info_jg,info_gg) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s,%s,%s,%s)",
    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#EEEEEE">
        <tr valign="top"> 
          ...
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
                <td><font color="#FF0000" size="3"><strong>经典案例信息发布</strong></font>
...
否 </font></td>
                              ...
                              <td width="174" valign="top"> <input name="info_flash" type="radio" value="1">
                                是
