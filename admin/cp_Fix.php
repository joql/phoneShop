...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "myform")) {
  $updateSQL = sprintf("UPDATE cpai SET m1=%s, m2=%s, m3=%s, bigtype=%s, smalltype=%s, grade=%s, price=%s, cp_hao=%s, info_top=%s, s_price=%s, hfei=%s, message=%s, tszf=%s, phpoto=%s, info_editor=%s, l_tel=%s, wx=%s, info_time=%s WHERE id=%s",
                       ...
                       GetSQLValueString($_POST['cp_hao'], "text"),
...
/*if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "myform")) {
  $updateSQL = sprintf("UPDATE kuhua SET m1=%s, m2=%s, m3=%s, bigtype=%s, smalltype=%s, grade=%s, price=%s, gh_hao=%s, s_price=%s, hfei=%s, message=%s, tszf=%s, phpoto=%s, info_editor=%s, l_tel=%s, wx=%s, info_time=%s WHERE id=%s",
                       GetSQLValueString($_POST['m1'], "int"),
                       GetSQLValueString($_POST['m2'], "int"),
                       GetSQLValueString($_POST['m3'], "int"),
                       GetSQLValueString($_POST['bigtype'], "int"),
                       ...
                       GetSQLValueString($_POST['grade'], "int"),
                       GetSQLValueString($_POST['price'], "int"),
                       GetSQLValueString($_POST['gh_hao'], "text"),
                       GetSQLValueString($_POST['s_price'], "text"),
                       GetSQLValueString($_POST['hfei'], "text"),
                       GetSQLValueString($_POST['message'], "text"),
                       GetSQLValueString($_POST['tszf'], "text"),
...
echo "<script language='javascript'>alert('修改固话号成功!');location.href='cp_Admin.php';</script>";
}


/*if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "myform")) {
  $insertSQL = sprintf("INSERT INTO kuhua (m1, m2, m3, bigtype, smalltype, grade, price, gh_hao, s_price, hfei, message, tszf, phpoto, info_editor, l_tel, wx, info_time) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['m1'], "int"),
                       GetSQLValueString($_POST['m2'], "int"),
                       GetSQLValueString($_POST['m3'], "int"),
                       GetSQLValueString($_POST['bigtype'], "int"),
...
echo "<script language='javascript'>alert('发布固话号成功!');location.href='gh_Admin.php';</script>";
}*/
...
/*if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "myform")) {
  $insertSQL = sprintf("INSERT INTO sj (pid, tel, theme, price, `day`, sj_hao, info_top, s_price, message, tszf, phpoto, info_editor, l_tel, wx, info_time,hfei) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s,%s, %s)",
...
$(document).ready(function(){                                      
 ...
 <script type="text/javascript" language="javascript">
    ...
    function check() {
	 ...
	 else if ($("[tname=news_title]").val().length<8) {
            alert('车牌号不能少于8个字符!');
            $("[tname=news_title]").val("");
            $("[tname=news_title]").focus();
            return false;
    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#EEEEEE">
        <tr valign="top"> 
          ...
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
                <td><font color="#FF0000" size="3"><strong>　　车牌号修改系统：</strong></font>
                    ...
                    <tr> 
                      <td><form action="<?php echo $editFormAction; ?>"   method="POST" name="myform" id="myform" style="margin=0px;">
                       <table width="100%" border="0" cellspacing="1" cellpadding="8">
                            ...
                            <tr>
                              <td width="100" rowspan="2" bgcolor="#999999"><strong><font color="#FFFFFF" size="2"><font color="#FF0000" size="2">*&nbsp;</font>固话号码信息:</font></strong></td> 
                              <td colspan="3" valign="top" ><font size="2"> 
                          <font size="3">号码全称：</font>
                          <input name="cp_hao" type="text" id="sj_hao" value="<?php echo $row_Recordset1['cp_hao']; ?>" size="13" maxlength="13" tname="news_title">
                               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font>
          ...
          <option value="">不限城市</option>
                            ...
                            <tr>
                              <td colspan="3" valign="top"  style="border-bottom:1px dashed #999999;"><!--<select name="theme" id="theme">
                                ...
                                <select name="price" id="price">
                                  ...
                                  <option value="1" <?php if (!(strcmp(1, $row_Recordset1['price']))) {echo "selected=\"selected\"";} ?>>500元以下</option>
                                  <option value="2" <?php if (!(strcmp(2, $row_Recordset1['price']))) {echo "selected=\"selected\"";} ?>>500-2000元</option>
                                  <option value="3" <?php if (!(strcmp(3, $row_Recordset1['price']))) {echo "selected=\"selected\"";} ?>>2000-1万元</option>
                                  <option value="4" <?php if (!(strcmp(4, $row_Recordset1['price']))) {echo "selected=\"selected\"";} ?>>1万-5万元</option>
                                  <option value="5" <?php if (!(strcmp(5, $row_Recordset1['price']))) {echo "selected=\"selected\"";} ?>>5万元以上</option>
                                 <!-- <option value="6" <?php if (!(strcmp(6, $row_Recordset1['price']))) {echo "selected=\"selected\"";} ?>>5000-10000元</option>
                                  <option value="7" <?php if (!(strcmp(7, $row_Recordset1['price']))) {echo "selected=\"selected\"";} ?>>10000元以上</option>-->
                                ...
                                <!--<label for="grade">规　律：</label>
                                <select name="grade" id="grade">-->
                                  <!--<option value="">=请选择号段=</option>--><!--<option value="">号码规律</option>-->
                                 <!-- <option value="-1" <?php if (!(strcmp(-1, $row_Recordset1['grade']))) {echo "selected=\"selected\"";} ?>>无规律</option>
                                  <option value="1" <?php if (!(strcmp(1, $row_Recordset1['grade']))) {echo "selected=\"selected\"";} ?>>尾数AAA</option>
                                  <option value="2" <?php if (!(strcmp(2, $row_Recordset1['grade']))) {echo "selected=\"selected\"";} ?>>尾数ABC</option>
                                  <option value="3" <?php if (!(strcmp(3, $row_Recordset1['grade']))) {echo "selected=\"selected\"";} ?>>尾数AABB</option>
                                  <option value="4" <?php if (!(strcmp(4, $row_Recordset1['grade']))) {echo "selected=\"selected\"";} ?>>尾数ABAB</option>
                                  <option value="5" <?php if (!(strcmp(5, $row_Recordset1['grade']))) {echo "selected=\"selected\"";} ?>>尾数ABBA</option>
                                  <option value="6" <?php if (!(strcmp(6, $row_Recordset1['grade']))) {echo "selected=\"selected\"";} ?>>尾数ABCD+</option>
                                  <option value="7" <?php if (!(strcmp(7, $row_Recordset1['grade']))) {echo "selected=\"selected\"";} ?>>尾数AABBCC</option>
                                  <option value="8" <?php if (!(strcmp(8, $row_Recordset1['grade']))) {echo "selected=\"selected\"";} ?>>尾数ABCABC</option>
                                  <option value="9" <?php if (!(strcmp(9, $row_Recordset1['grade']))) {echo "selected=\"selected\"";} ?>>尾数AAABB</option>
                                  <option value="10" <?php if (!(strcmp(10, $row_Recordset1['grade']))) {echo "selected=\"selected\"";} ?>>尾数AAAA+</option>
                                  <option value="11" <?php if (!(strcmp(11, $row_Recordset1['grade']))) {echo "selected=\"selected\"";} ?>>中间AAA</option>
                                  <option value="12" <?php if (!(strcmp(12, $row_Recordset1['grade']))) {echo "selected=\"selected\"";} ?>>中间AABB</option>
                                  <option value="13" <?php if (!(strcmp(13, $row_Recordset1['grade']))) {echo "selected=\"selected\"";} ?>>中间AAAA+</option>
                                  <option value="14" <?php if (!(strcmp(14, $row_Recordset1['grade']))) {echo "selected=\"selected\"";} ?>>中间AAABB</option>
                                  <option value="15" <?php if (!(strcmp(15, $row_Recordset1['grade']))) {echo "selected=\"selected\"";} ?>>中间AABBB</option>
                                  <option value="16" <?php if (!(strcmp(16, $row_Recordset1['grade']))) {echo "selected=\"selected\"";} ?>>中间AAABBB</option>
                                  <option value="17" <?php if (!(strcmp(17, $row_Recordset1['grade']))) {echo "selected=\"selected\"";} ?>>中间AABBCC</option>
                                  <option value="18" <?php if (!(strcmp(18, $row_Recordset1['grade']))) {echo "selected=\"selected\"";} ?>>中间ABCABC</option>
							</select>
                            ...
                            <tr>
                              ...
                              <td valign="top"><font size="2">
                                <!--<input <?php if (!(strcmp($row_Recordset1['m1'],-1))) {echo "checked=\"checked\"";} ?> name="m1" type="checkbox" id="m1" value="-1">
                                无线
                                &nbsp;
                                <input <?php if (!(strcmp($row_Recordset1['m2'],1))) {echo "checked=\"checked\"";} ?> name="m2" type="checkbox" id="m2" value="1"> 
                                有线
&nbsp;
<input <?php if (!(strcmp($row_Recordset1['m3'],2))) {echo "checked=\"checked\"";} ?> name="m3" type="checkbox" id="m3" value="2">
商务一号通&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-->归属：&nbsp;置顶靓号:<input <?php if (!(strcmp($row_Recordset1['info_top'],"1"))) {echo "checked=\"checked\"";} ?> name="info_top" type="radio" value="1" checked="CHECKED">
  |&nbsp;&nbsp;天价靓号:<input <?php if (!(strcmp($row_Recordset1['info_top'],"2"))) {echo "checked=\"checked\"";} ?> name="info_top" type="radio" value="2">
...
value="200" size="5" readonly>个字符 </td>
                            ...
                            <tr>
                              ...
                              <td colspan="3" valign="top">&nbsp;<img src="../images/<?php echo $row_Recordset1['phpoto']; ?>" alt="这是显示上传预览图片的位置" name="showImg" id="showImg"  width="60px" onClick='javascript:alert("这是显示上传预览图片的位置");'>
    ...
    <input type="button" name="Submit" value="上传图片" onClick="javascript:openwindow('fupload.php?useForm=myform&amp;prevImg=showImg&amp;upUrl=../images&amp;ImgS=400&amp;ImgW=800&amp;ImgH=600&amp;reItem=rePic','fileUpload',400,180)">
                            ...
                            <input name="rePic" type="hidden" id="rePic" size="4" value="<?php echo $row_Recordset1['phpoto']; ?>"></td></tr>
