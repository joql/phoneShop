...
if ((isset($_GET['info_id'])) && ($_GET['info_id'] != "") && (isset($_GET['delsure']))) {
  $deleteSQL = sprintf("DELETE FROM info WHERE info_id=%s",
                       GetSQLValueString($_GET['info_id'], "int"));

  mysql_select_db($database_connch21, $connch21);
  $Result1 = mysql_query($deleteSQL, $connch21) or die(mysql_error());

  $deleteGoTo = "infoAdmin.php";
    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#EEEEEE">
        <tr valign="top"> 
          ...
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
                <td><font color="#FF0000" size="3"><strong>服务范围删除信息-</strong></font>
                  <?php echo $row_Recinfo['info_title']; ?>
                  <hr size="1" noshade> 
