...
$sql="insert into webcount(count_id,count_ip,count_time) values(null,'$userIp','$nowtime')";
...
欢迎光本站，您是第 <font color="#FF0000"><?php echo 501300 + $totalRows_RecCount ?></font> 位访客，本日浏览人次： <?php echo $totalRows_TodayCount ?> 人，</font><font size="2">目前线上人数：<?php echo $onlineusr;?> 。
<?php
