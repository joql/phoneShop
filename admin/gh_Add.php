...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "myform")) {
  if(empty($_POST['m1'])&&empty($_POST['m2'])&&empty($_POST['m3'])){echo "<script language='javascript'>alert('必须要选择一个类型的栏目（即无线、有线或商务一号通）!');location.href='javascript:history.go(-1)';</script>";
} 
  $insertSQL = sprintf("INSERT INTO kuhua (m1, m2, m3, bigtype, smalltype, grade, price, gh_hao, s_price, hfei, message, tszf, phpoto, info_editor, l_tel, wx, info_time,info_top) VALUES (%s,%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                    ...
                    <tr> 
                      <td><form action="<?php echo $editFormAction; ?>"   method="POST" name="myform" id="myform" style="margin=0px;">
                       <table width="100%" border="0" cellspacing="1" cellpadding="8">
                          ...
                          <input name="gh_hao" type="text" id="sj_hao" size="13" maxlength="13" tname="news_title">
                               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font>
          ...
          <option value="">不限城市</option>
                            ...
                            <tr>
                              ...
                              <td valign="top"><font size="2">
                                ...
                                无线
                                &nbsp;
                                <input name="m2" type="checkbox" id="m2" value="1" checked="CHECKED"> 
                                有线
&nbsp;
<input name="m3" type="checkbox" id="m3" value="2">
商务一号通&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;归属：&nbsp;置顶靓号:<input name="info_top" type="radio" value="1" checked="CHECKED">
  &nbsp;&nbsp;天价靓号:<input name="info_top" type="radio" value="2">
...
value="200" size="5" readonly>个字符 </td>
                            ...
                            <tr>
                              ...
                              <td colspan="3" valign="top">&nbsp;<img src="icon_prev.gif" alt="这是显示上传预览图片的位置" name="showImg" id="showImg"  width="60px" onClick='javascript:alert("这是显示上传预览图片的位置");'>
