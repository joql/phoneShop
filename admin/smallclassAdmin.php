...
$query_Recclass = "SELECT * FROM smallclass ORDER BY smallclass_id DESC";
    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#EEEEEE">
        <tr valign="top"> 
          ...
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
                <td><font color="#FF0000" size="3"><strong>管理信息中类别</strong></font> <font color="#FF0000" size="3">（B类）</font> 
                  <hr size="1" noshade> 
                  <table width="100%" border="0" cellspacing="1" cellpadding="2">
                    ...
                    <?php do { ?>
                      <tr bgcolor="#FFFFFF">
                        ...
                        <td width="100" align="center"><font size="2"><a href="smallclassFix.php?<?php echo $MM_keepNone.(($MM_keepNone!="")?"&":"")."smallclass_id=".$row_Recclass['smallclass_id'] ?>">编辑</a> <a href="smallclassDel.php?<?php echo $MM_keepNone.(($MM_keepNone!="")?"&":"")."smallclass_id=".$row_Recclass['smallclass_id'] ?>">删除</a></font></td>
                      </tr>
