...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE smallclass SET smallclassname=%s, class_id=%s, smallclassnum=%s WHERE smallclass_id=%s",
                       ...
                       GetSQLValueString($_POST['smallclass_id'], "int"));

  mysql_select_db($database_connch21, $connch21);
  $Result1 = mysql_query($updateSQL, $connch21) or die(mysql_error());

  $updateGoTo = "smallclassAdmin.php";
  if (isset($_SERVER['QUERY_STRING'])) {
    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#EEEEEE">
        <tr valign="top"> 
          ...
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
                <td height="192"><font color="#FF0000" size="3"><strong>修改信息中类别</strong></font> <font color="#FF0000" size="3">（B类）</font> 
                          ...
                          <table width="100%" border="0" cellspacing="1" cellpadding="2">
                            ...
                            <td width="80" align="right" bgcolor="#999999"><strong><font color="#FFFFFF" size="2">信息类别：</font></strong></td>
                              <td valign="top"><font size="2"> 
                                <input name="smallclassname" type="text" id="smallclassname" value="<?php echo $row_Recclass['smallclassname']; ?>">
                                </font></td>
                            </tr>
...
do {  
?>
                                   <option value="<?php echo $row_Recbigclass['classname']?>"<?php if (!(strcmp($row_Recbigclass['classname'], $row_Recclass['class_id']))) {echo "selected=\"selected\"";} ?>><?php echo $row_Recbigclass['classname']?></option>
                                   <?php
...
?>
                           ...
                           <tr> 
                              ...
                              <td valign="top"> <font size="2">
                                 <input name="smallclassnum" type="text" id="smallclassnum" value="<?php echo $row_Recclass['smallclassnum']; ?>">
                                <input name="smallclass_id" type="hidden" id="smallclass_id" value="<?php echo $row_Recclass['smallclass_id']; ?>">
                              </font></td>
                            </tr>  
