...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "myform")) {
  $insertSQL = sprintf("INSERT INTO sll (a, b, c, aprm, minprice, tctype, sLL_hao, s_price, hfei, message, tszf, rePic, info_editor, l_tel, wx, zding, `time`) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
echo "<script language='javascript'>alert('发布400号码成功!');location.href='sLL_Admin.php';</script>";
}
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#EEEEEE">
        <tr valign="top"> 
          ...
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
                <td><font color="#FF0000" size="3"><strong>　　400号码发布上传系统：</strong></font>
                    ...
                    <tr> 
                      <td><form action="<?php echo $editFormAction; ?>"   method="POST" name="myform" id="myform" style="margin=0px;">
                       <table width="100%" border="0" cellspacing="1" cellpadding="8">
                          ...
                          <input name="sLL_hao" type="text" id="sj_hao" size="13" maxlength="13" tname="news_title">
                               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font>
  ...
  <OPTGROUP label=电信> <OPTION value=4008>4008</OPTION> <OPTION 
    value=4009>4009</OPTION> </OPTGROUP></SELECT>
  ...
  value=21>中间AAABBB</OPTION></SELECT>
                     ...
                     <LABEL class=ms_label for=letter>资费：</LABEL> <INPUT value=0 CHECKED 
...
0.2-0.3元/分钟           
 ...
 <P><LABEL class=ms_label for=letter>套餐：</LABEL> <SELECT name=minprice> <OPTION 
  selected value=0>不限</OPTION> <OPTION value="0-1000" >1000元以下</OPTION> 
...
否-->
                            ...
                            <tr>
                              ...
                              无置顶 
                                <input name="zding" type="radio" id="radio1" value="无置顶" checked="CHECKED">|
                              
                              移动置顶 
                                <input type="radio" name="zding" id="radio1" value="移动置顶">
                             | 联通置顶
                                <input type="radio" name="zding" id="radio2" value="联通置顶">
                              | 电信置顶<input type="radio" name="zding" id="radio3" value="电信置顶">
                             </td>
