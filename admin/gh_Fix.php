...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "myform")) {
  $updateSQL = sprintf("UPDATE kuhua SET m1=%s, m2=%s, m3=%s, bigtype=%s, smalltype=%s, grade=%s, price=%s, gh_hao=%s, info_top=%s, s_price=%s, hfei=%s, message=%s, tszf=%s, phpoto=%s, info_editor=%s, l_tel=%s, wx=%s, info_time=%s WHERE id=%s",
...
echo "<script language='javascript'>alert('修改固话号成功!');location.href='gh_Admin.php';</script>";
}
  ...
  <script type="text/javascript" language="javascript">
    ...
    function check() {
	  ...
	  if ($("[tname=news_title]").val() == "") {
		 ...
		 else if ($("[tname=news_title]").val().length<12) {
            alert('电话不能少于12个字符!');
            $("[tname=news_title]").val("");
            $("[tname=news_title]").focus();
            return false;
    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#EEEEEE">
        <tr valign="top"> 
          ...
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
                <td><font color="#FF0000" size="3"><strong>　　固话号发布上传系统：</strong></font>
                    ...
                    <tr> 
                      <td><form action="<?php echo $editFormAction; ?>"   method="POST" name="myform" id="myform" style="margin=0px;">
                       <table width="100%" border="0" cellspacing="1" cellpadding="8">
                          ...
                          <input name="gh_hao" type="text" id="sj_hao" value="<?php echo $row_Recordset1['gh_hao']; ?>" size="13" maxlength="13" tname="news_title">
                               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font>
                            ...
                            <tr>
                              <td colspan="3" valign="top"  style="border-bottom:1px dashed #999999;"><!--<select name="theme" id="theme">
                                ...
                                <select name="price" id="price">
                                  ...
                                  <option value="1" <?php if (!(strcmp(1, $row_Recordset1['price']))) {echo "selected=\"selected\"";} ?>>100元以下</option>
                                  <option value="2" <?php if (!(strcmp(2, $row_Recordset1['price']))) {echo "selected=\"selected\"";} ?>>100-500元</option>
                                  <option value="3" <?php if (!(strcmp(3, $row_Recordset1['price']))) {echo "selected=\"selected\"";} ?>>500-1000元</option>
                                  <option value="4" <?php if (!(strcmp(4, $row_Recordset1['price']))) {echo "selected=\"selected\"";} ?>>1000-2000元</option>
                                  <option value="5" <?php if (!(strcmp(5, $row_Recordset1['price']))) {echo "selected=\"selected\"";} ?>>2000-5000元</option>
