...
$query_Recordset1 = "SELECT * FROM xx_smallclass ORDER BY x_num DESC";
    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#EEEEEE">
        <tr valign="top"> 
          ...
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
                <td><font color="#FF0000" size="3"><strong>管理信息类别</strong>&nbsp;(C类）</font> 
                  <hr size="1" noshade> 
                  <table width="100%" border="0" cellspacing="1" cellpadding="2">
                    ...
                    <?php do { ?>
                      <tr bgcolor="#FFFFFF">
                        <td width="133"><?php echo $row_Recordset1['xx_id']; ?></td>
                        <td width="184"><?php echo $row_Recordset1['x_mame']; ?></td>
                        <td width="184"><?php echo $row_Recordset1['smallclass_id']; ?></td>
                        <td width="184"><?php echo $row_Recordset1['class_id']; ?></td>
                        <td><?php echo $row_Recordset1['x_num']; ?></td>
                        <td width="100" align="center"><font size="2"><a href="smallclassFix_xx.php?xx_id=<?php echo $row_Recordset1['xx_id']; ?>">编辑</a> <a href="smallclassDel_xx.php?xx_id=<?php echo $row_Recordset1['xx_id']; ?>">删除</a></font></td>
                      </tr>
