...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "myform")) {
  ...
  $insertSQL = sprintf("INSERT INTO cpai (m1, m2, m3, bigtype, smalltype, grade, price, cp_hao, s_price, hfei, message, tszf, phpoto, info_editor, l_tel, wx, info_time,info_top) VALUES (%s,%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
echo "<script language='javascript'>alert('发布车牌号成功!');location.href='cp_Admin.php';</script>";
}
    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#EEEEEE">
        <tr valign="top"> 
          ...
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
                <td><font color="#FF0000" size="3"><strong>　　车牌号发布上传系统：</strong></font>
                    ...
                    <tr> 
                      <td><form action="<?php echo $editFormAction; ?>"   method="POST" name="myform" id="myform" style="margin=0px;">
                       <table width="100%" border="0" cellspacing="1" cellpadding="8">
                          ...
                          <input name="cp_hao" type="text" id="sj_hao" size="13" maxlength="13" tname="news_title">
                               &nbsp;例：黑A·A6666&nbsp;&nbsp;&nbsp;&nbsp;</font>
