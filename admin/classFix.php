...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE bigclass SET classname=%s, classnum=%s WHERE class_id=%s",
...
mysql_select_db($database_connch21, $connch21);
$query_Recclass = sprintf("SELECT * FROM bigclass WHERE class_id = %s ORDER BY class_id DESC", GetSQLValueString($colname_Recclass, "int"));
