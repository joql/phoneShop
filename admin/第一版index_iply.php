...
$query_Recordset1 = "SELECT * FROM webcount ORDER BY count_time DESC";
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td colspan="3" bgcolor="#FFFFFF"><!--网站浏览总人数：<?php echo $totalRows_Recordset1 ?>　-->　
　
<?php include("../footer_ip.php");?> 　　最后访客访问时间为：<?php echo $row_Recordset1['count_time']; ?>
  ...
  <?php do { ?>
    <tr>
      ...
      <td bgcolor="#FFFFFF"><a href='http://www.baidu.com/s?wd=<?php echo $row_Recordset1['count_ip']; ?>' target="_blank"><?php echo $row_Recordset1['count_ip']; ?></a></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><?php include("fanye_ip.php");?> </td>
  </tr>
</table>
