...
$query_Recinfo = "SELECT * FROM shop ORDER BY info_id DESC";
    ...
    <td ><table  width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#ACACAC">
        <tr valign="top"> 
          ...
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
                <td><strong><font color="#FF0000" size="3">经典案例信息管理</font></strong>
                  <hr size="1" noshade> 
                  <table width="100%" border="0" cellspacing="1" cellpadding="2">
                    
                    
                    <tr bgcolor="#CCCCCC"> 
                      <td width="139"><font size="2">ID</font></td>
                      <td width="150"><font size="2">标题</font></td>
                      <td  colspan="4"><font size="2">&nbsp;</font></td>
                      
                      <td width="90" align="center"><font size="2">执行功能</font></td>
                    </tr>
                    <?php do { ?>
                      <tr bgcolor="#FFFFFF" style="cursor: hand;" onMouseOver="this.style.backgroundColor='#F0F0F0'" onMouseOut="this.style.backgroundColor=''">
                        <td width="139" height="30"><?php echo $row_Recinfo['info_id']; ?></td>
                        <td width="150"><?php echo $row_Recinfo['info_title']; ?></td>
                       
                        <td colspan="4"><?php /*start db_input script*/ if ($row_Recinfo['info_top'] == 1){ ?>
...
<?php } /*end db_input script*/ ?></td>
                        <td width="90" align="center"><font size="2"><a href="shopFix.php?<?php echo $MM_keepNone.(($MM_keepNone!="")?"&":"")."info_id=".$row_Recinfo['info_id'] ?>">编辑</a> —<a href="shopDel.php?<?php echo $MM_keepNone.(($MM_keepNone!="")?"&":"")."info_id=".$row_Recinfo['info_id'] ?>">删除</a></font></td>
                      </tr>
