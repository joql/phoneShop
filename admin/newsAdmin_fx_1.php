...
$query_Recnews = sprintf("SELECT news_id, news_time, news_title, news_photo, news_top, quyu, `number` FROM news WHERE quyu = %s ORDER BY news_id DESC", GetSQLValueString($colname_Recnews, "int"),GetSQLValueString($key_Recnews, "int"));
