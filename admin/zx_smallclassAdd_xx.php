...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO zx_xx_smallclass (zx_x_mame, class_id, smallclass_id, xx_name_id, x_num) VALUES (%s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['zx_x_mame'], "text"),
                       GetSQLValueString($_POST['class_id'], "text"),
                       GetSQLValueString($_POST['smallclass_id'], "text"),
  ...
  $insertGoTo = "zx_smallclassAdmin_xx.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_connch21, $connch21);
$query_Rec_xx = "SELECT smallclass_id, smallclassname, smallclassnum FROM smallclass ORDER BY smallclassnum ASC";
...
mysql_select_db($database_connch21, $connch21);
$query_zh = "SELECT * FROM xx_smallclass ORDER BY x_num ASC";
$zh = mysql_query($query_zh, $connch21) or die(mysql_error());
$row_zh = mysql_fetch_assoc($zh);
$totalRows_zh = mysql_num_rows($zh);
?>
<html>
<head>
<title>广告管理</title>
    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#EEEEEE">
        <tr valign="top"> 
          ...
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
                <td><font color="#FF0000" size="3"><strong>新增最小分类</strong>&nbsp;(D类）</font>
                          ...
                          <table width="100%" border="0" cellspacing="1" cellpadding="2">
                            <tr> 
                              ...
                              <td valign="top"><font size="2"> 
                                <input name="zx_x_mame" type="text" id="zx_x_mame">
                                </font></td>
                            </tr>
                            <tr> 
...
do {  
?>
                                   <option value="<?php echo $row_Recbigclass['classname']?>"><?php echo $row_Recbigclass['classname']?></option>
                                   <?php
...
?>
                              ...
                              <td valign="top"> <font size="2">
                                 <select  name="smallclass_id" type="text" id="smallclass_id">
                                   <?php
do {  
?>
                                   <option value="<?php echo $row_Rec_xx['smallclassname']?>"><?php echo $row_Rec_xx['smallclassname']?></option>
                                   <?php
...
do {  
?>
                                   <option value="<?php echo $row_zh['x_mame']; ?>"><?php echo $row_zh['x_mame']; ?></option>
                                   <?php
} while ($row_zh = mysql_fetch_assoc($zh));
  $rows = mysql_num_rows($zh);
  if($rows > 0) {
      mysql_data_seek($zh, 0);
	  $row_zh = mysql_fetch_assoc($zh);
  }
?>
                                 </select>
                           ...
                           <tr> 
                              ...
                              <td valign="top"> <font size="2">
                                 <input name="smallclassnum" type="text" id="smallclassnum">
                              </font></td></tr>  
