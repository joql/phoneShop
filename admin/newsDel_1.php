...
unlink($imgSource);//执行操作
  ...
  /*$deleteGoTo = "newsAdmin_1.php";
  if (isset($_SERVER['QUERY_STRING'])) {
    $deleteGoTo .= (strpos($deleteGoTo, '?')) ? "&" : "?";
    $deleteGoTo .= $_SERVER['QUERY_STRING'];
  }
  header(sprintf("Location: %s", $deleteGoTo));*/
  echo "<script language='javascript'>alert('删除新闻成功!');location.href='newsAdmin_1.php';</script>";
}
    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#EEEEEE">
        <tr valign="top"> 
          ...
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
                <td><font color="#FF0000" size="3"><strong>删除新闻-</strong></font><?php echo $row_Recnews['news_id']; ?>
              ...
              <tr> 
                <td><form name="form1" method="get" action="">
                  ...
                  <input name="news_id" type="hidden" id="news_id" value="<?php echo $row_Recnews['news_id']; ?>"> <input type="button" name="Submit4" value="回上一页" onClick="window.history.back();">
                  <input name="delpic" type="hidden" id="delpic" value="<?php echo $row_Recnews['news_photo']; ?>">
                </form></td>
              </tr>
            </table></td>
