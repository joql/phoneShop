...
if ((isset($_GET['smallclass_id'])) && ($_GET['smallclass_id'] != "") && (isset($_GET['delsure']))) {
  $deleteSQL = sprintf("DELETE FROM smallclass WHERE smallclass_id=%s",
                       GetSQLValueString($_GET['smallclass_id'], "int"));

  mysql_select_db($database_connch21, $connch21);
  $Result1 = mysql_query($deleteSQL, $connch21) or die(mysql_error());

  $deleteGoTo = "smallclassAdmin.php";
...
mysql_select_db($database_connch21, $connch21);
$query_Recclass = sprintf("SELECT * FROM smallclass WHERE smallclass_id = %s", GetSQLValueString($colname_Recclass, "int"));
$Recclass = mysql_query($query_Recclass, $connch21) or die(mysql_error());
$row_Recclass = mysql_fetch_assoc($Recclass);
$totalRows_Recclass = mysql_num_rows($Recclass);$colname_Recclass = "-1";
if (isset($_GET['smallclass_id'])) {
  $colname_Recclass = $_GET['smallclass_id'];
}
mysql_select_db($database_connch21, $connch21);
    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#EEEEEE">
        <tr valign="top"> 
          ...
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
                <td><font color="#FF0000" size="3"><strong>删除信息中类别</strong></font> <font color="#FF0000" size="3">（B类）</font><font color="#FF0000" size="3"><strong>-</strong></font>
                  <?php echo $row_Recclass['class_id']; ?>
                  <hr size="1" noshade> 
                  <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td valign="top"><font size="2"><strong>类别</strong>：<?php echo $row_Recclass['smallclassname']; ?></font></td>
                    </tr>
                  </table>
                </td>
              </tr>
