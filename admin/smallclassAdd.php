...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO smallclass (smallclassname, class_id, smallclassnum) VALUES (%s, %s, %s)",
  ...
  $insertGoTo = "smallclassAdmin.php";
  if (isset($_SERVER['QUERY_STRING'])) {
    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#EEEEEE">
        <tr valign="top"> 
          ...
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
                <td><font color="#FF0000" size="3"><strong>新增信息中类别</strong></font> 
                  <font color="#FF0000" size="3">（B类）</font>
