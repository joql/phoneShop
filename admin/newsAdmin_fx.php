...
$colname_Recnews = "-1";
if (isset($_GET['quyu'])) {
  $colname_Recnews = $_GET['quyu'];
}
$key_Recnews = "-1";
if (isset($_GET['number'])) {
  $key_Recnews = $_GET['number'];
}
mysql_select_db($database_connch21, $connch21);
$query_Recnews = sprintf("SELECT news_id, news_time, news_title, news_photo, news_top, quyu, `number` FROM news WHERE quyu = %s and number=%s ORDER BY news_id DESC", GetSQLValueString($colname_Recnews, "int"),GetSQLValueString($key_Recnews, "int"));
                      ...
                      <tr bgcolor="#FFFFFF" style="cursor: hand;" onMouseOver="this.style.backgroundColor='#F0F0F0'" onMouseOut="this.style.backgroundColor=''">
                        ...
                        <td width="486"><?php /*start db_input script*/ if ($row_Recnews['quyu'] == 1){ ?>
                         ...
                         <?php /*start db_input script*/ if ($row_Recnews['quyu'] == 2){ ?>
                          [手册指导] <?php } /*end db_input script*/ ?>
                          
                           <?php /*start db_input script*/ if ($row_Recnews['number'] == 1){ ?>
                          [家具知识大全]<?php } /*end db_input script*/ ?>
