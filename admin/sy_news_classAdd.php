...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO sy_bigclass (classname, classnum) VALUES (%s, %s)",
    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#EEEEEE">
        <tr valign="top"> 
          ...
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
                <td><font color="#FF0000" size="3"><strong>新增信息大类别</strong></font> 
                    ...
                    <tr> 
                      <td><form action="<?php echo $editFormAction; ?>"   method="POST" name="form1" style="margin=0px;">
                          <table width="100%" border="0" cellspacing="1" cellpadding="2">
                            <tr> 
                              <td width="80" align="right" bgcolor="#999999"><strong><font color="#FFFFFF" size="2">类别名称：</font></strong></td>
                           ...
                           <tr> 
                              ...
                              <td valign="top"> <font size="2">
                                 <input name="classnum" type="text" id="classnum">
                              </font></td></tr>  
