...
function GetSQLValueString($theValue, $theType, $theDefinedValue = "", $theNotDefinedValue = "") 
{
 ...
 $info_top=$_GET['info_top'];
if(!isset($info_top)){$info_top=2;}
 $key=$_GET['key'];
...
$query_Recordset1 = "SELECT * FROM kuhua where  info_top=$info_top $link ORDER BY id DESC";
...
<div id="top-slide" class="swiper-container top-slide swiper-container-horizontal" data-swiper="[object Object]">
	<div class="swiper-wrapper" style="transition-duration: 0ms; transform: translate3d(-2846px, 0px, 0px);">
			...
			<a href="http://#/escrow/633/" target="_blank"><img src="./index_files/5837d844a438f.jpg"></a>
		</div>
				<div class="swiper-slide swiper-slide-prev" style="width: 1423px;">
			<a href="http://#/escrow/52222/" target="_blank"><img src="./index_files/59015f8635479.jpg"></a>
		</div>
				<div class="swiper-slide swiper-slide-active" style="width: 1423px;">
			<a href="http://#/escrow/621/" target="_blank"><img src="./index_files/593520343ebec.jpg"></a>
		</div>
					</div>
...
<div class="swiper-container">
  <div class="swiper-wrapper">
    <div class="swiper-slide" style="background:#fff;">
   	 <form action="gh_gd2.php" method="get" class="sreach" id="mhDianhuaForm" >
	  		<!--<p><label>类型：</label>
...
-->	</ul>
 ...
 <div class="cityhaoma">
 	<ul id="mobile_search_more_list">
	     <?php do { ?>	<li><a href="gh_xy.php?id=<?php echo $row_Recordset1['id']; ?>" target="_blank">
        	<div class="ch_show fleft">
            	<h1><span class="orange"><?php echo substr($row_Recordset1['gh_hao'],0,4); ?></span>-<?php echo substr($row_Recordset1['gh_hao'],4,8); ?></h1>
 ...
 <?php include("fanye.php");?>
	...
	<!-- 当前位置 --> 
<div class="location">
	<a href="index.php">首页</a>&nbsp;&gt;&nbsp;<a href="gh.php">固定电话</a>&nbsp;&gt;&nbsp;搜索选号
</div> 
