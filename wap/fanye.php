...
.fenye a:hover,a:active{ text-decoration:underline; color:##004a96;}
...
.fenye ul li.fangkuangcurrent{ width:28px;border:1px solid #999999;background:#333; color:#FFFFFF; font-weight:bold;}
...
.fenye ul li a:hover,.fenye ul li a:active{ text-decoration:none; background:#004a96; color:#FFFFFF;}
/*分页结束*/
