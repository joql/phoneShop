...
<style type="text/css">
    ...
    *{margin:0;padding:0;}
	div{margin:0 auto;}
    body{font:14px Microsoft YaHei,\5FAE\8F6F\96C5\9ED1,SimSun,\5B8B\4F53,Arial,Verdana;color:#000;text-align: center;padding-top:60px;background:#FFF;} 
    a:link,a:visited{color:#F00;text-decoration:none;}a:hover{color:#090;text-decoration:underline;}
    ul,li{list-style:none;display:block;}
    img{border:0 none;vertical-align:middle;}
    #head{width:60%;padding:0 0 30px;text-align:center;border-bottom:2px dotted #DDD;}
    #bdok{
	width: 60%;
	background: #FFF;
	height: auto;
