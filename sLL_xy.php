...
<div class="main">
<div class="onepage_bt">当前位置：<a href="/">首页</a>&nbsp;&gt;&nbsp;<a href="400.php">400电话</a>&nbsp;&gt;&nbsp;黑龙江&nbsp;&gt;&nbsp;<a href="javascript:window.history.back();" >400号码</a>&nbsp;&gt;<?php echo $row_Recordset1['cp_hao']; ?>号码详情</div>
<!--固定电话详情-->
	<div class="hmxq fl">
  ...
  <tr>
    <td class="hmxq_sx">特殊数字：</td>
    <td class="hmxq_nr"><?php echo $row_Recordset1['tszf']; ?>
      <!--所属分类-->
     </td>
    <td class="hmxq_sx">含费：</td>
    <td class="hmxq_nr"><?php echo $row_Recordset1['hfei']; ?></td>
   </tr>
    <tr>
    ...
    <td colspan="3" class="hmxq_nr sj-phone"><?php echo $row_Recordset1['l_tel']; ?> 　
      <?php /*start db_input script*/ if ($row_Recordset1['wx'] != ""){ ?>
        微信：<?php echo $row_Recordset1['wx']; ?>
        <?php } /*end db_input script*/ ?><br></td>
    </tr>
</tbody></table>
...
<div class="number_01 "><span><a href="400.php">更多</a></span>为您推荐其它的400靓号</div>
        	<ul>
									<?php do { ?>
								    <li><a href="sLL_xy.php?id=<?php echo $row_Recordset2['id']; ?>"><h2><i class="liang"></i><span class="yellow"><?php echo substr($row_Recordset2['sLL_hao'],0,4); ?></span><?php echo substr($row_Recordset2['sLL_hao'],4,7); ?></h2><p><span class="fl">
