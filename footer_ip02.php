...
$sql="insert into webcount02(count_id,count_ip,lf_url,count_time) values(null,'$userIp','$url','$nowtime')";
...
mysql_select_db($database_connch21, $connch21);
$query_RecCount = "SELECT * FROM webcount02";
...
mysql_select_db($database_connch21, $connch21);
$query_TodayCount = "SELECT * FROM webcount02 WHERE count_time LIKE '$countDay%'";
