                        ...
                        <?php if ($totalRows_Recordset1 > 0) { // Show if recordset not empty ?>
                          <table  bgcolor="#CCCCCC"width="100%" border="0" cellspacing="1" cellpadding="2">
                            <tr bgcolor="#CCCCCC" align="center">
                              ...
                              第<?php echo $row_Recordset1['id']; ?>单</h3></td>
                              <td bgcolor="#EAEAEA"><font size="2">名字</font></td>
                            ...
                            <tr bgcolor="#FFFFFF" align="center">
                              ...
                              <td bgcolor="#FFFFFF"><?php echo $row_Recordset1['phone']; ?></td>
                          ...
                          <tr bgcolor="#FFFFFF">
                            ...
                            <tr >
                              ...
                              <tr>
                                  <td colspan="9" align="left" bgcolor="#FFFFFF">　订单号：<?php echo $row_Recordset1['order_no']; ?>　　成交时间：<?php if($row_Recordset1['update_time']!=''){echo date("Y-m-d H:i:s",$row_Recordset1['update_time']);}else{echo "未成交！";} ?></td>
                                </tr>
                                <tr>
                                ...
                                <tr align="center">
                                  <td height="27" bgcolor="#FFFFFF">2</td>
                                  <td bgcolor="#FFFFFF"><?php echo $row_Recordset1['trade_no']; ?></td>
                                <!--  <td bgcolor="#FFFFFF"><?php echo $row_Recordset1['trade_no']; ?></td>-->
                                  <td bgcolor="#FFFFFF"><?php echo $row_Recordset1['order_money']; ?></td>
                                  <td bgcolor="#FFFFFF"><?php echo $row_Recordset1['pay_type']; ?></td>
                                  <td bgcolor="#FFFFFF"><?php if($row_Recordset1['state']==1){echo '<span style=" color:red;">买家已付款</span>';}else{echo "等待买家付款";} ?> </td>
